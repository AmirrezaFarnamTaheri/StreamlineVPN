...
def create_source_entry(url: str, category: str) -> Dict[str, Any]:
    ...
    region = 'iran' if category in ['barry_far', 'rayan_config', 'mhdi_taheri', 'iranian_cypherpunks'] else 'global'
...
def update_unified_config(categories: Dict[str, List[str]], config_path: str = "config/sources.unified.yaml"):
...
def create_removal_script(categories: Dict[str, List[str]], output_path: str = "scripts/remove_hardcoded_sources.py"):
