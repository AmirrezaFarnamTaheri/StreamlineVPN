...
class DeploymentManager:
        ...
        try:
            ...
            if self.docker_client:
                image, logs = self.docker_client.images.build(
                    path=".", dockerfile=dockerfile, tag=tag, rm=True
                )
    ...
    def create_k8s_configmap(self, namespace: str = "vpn-merger") -> bool:
        ...
        try:
            ...
            configmap = client.V1ConfigMap(
                metadata=client.V1ObjectMeta(name="vpn-merger-config", namespace=namespace),
                data=configmap_data,
            )

            try:
                self.k8s_client.read_namespaced_config_map("vpn-merger-config", namespace)
    ...
    def deploy_k8s_application(
        self, namespace: str = "vpn-merger", image_tag: str = "vpn-merger:latest"
    ) -> bool:
        ...
        try:
            ...
            deployment = client.V1Deployment(
                metadata=client.V1ObjectMeta(name="vpn-merger", namespace=namespace),
                spec=client.V1DeploymentSpec(
                    replicas=3,
                    selector=client.V1LabelSelector(match_labels={"app": "vpn-merger"}),
                    template=client.V1PodTemplateSpec(
                        metadata=client.V1ObjectMeta(labels={"app": "vpn-merger"}),
                            ...
                            containers=[
                                client.V1Container(
                                    ...
                                    env=[
                                        ...
                                        client.V1EnvVar(name="METRICS_ENABLED", value="1"),
                                    ],
            ...
            try:
                self.k8s_apps_client.read_namespaced_deployment("vpn-merger", namespace)
...
async def main():
    ...
    success = manager.deploy_to_production(image_tag="vpn-merger:v2.0.0")
