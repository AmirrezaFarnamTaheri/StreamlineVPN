...
class APIEnhancer:
    ...
    def create_graphql_schema(self) -> Dict[str, Any]:
        ...
        schema = {
            "types": {
                "Source": {
                    "fields": ["id", "url", "format", "protocols", "weight", "priority", "region", "health", "last_updated", "config_count", "enabled"]
                },
                "Outputs": {
                    "fields": ["raw", "base64", "json", "clash", "singbox"]
                },
                "Stats": {
                    "fields": ["total_configs", "sources_count", "processing_time", "quality_score", "cache_hit_rate", "error_rate", "last_updated"]
                },
                "Recommendation": {
