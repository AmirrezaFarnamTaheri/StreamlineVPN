...
def replace_example_urls_in_file(file_path: str):
    ...
    replacements = [
        ...
        (
            r"vless://uuid@example\.com",
            "vless://12345678-90ab-12f3-a6c5-4681aaaaaaaa@test.example.com",
        ),
        ...
        (
            r'# domain length \(15 for "cdn\.example\.com"\)',
            '# domain length (19 for "cdn.test.example.com")',
        ),
        (
            r'# domain length \(15 for "example\.com"\)',
            '# domain length (11 for "test.example.com")',
        ),
