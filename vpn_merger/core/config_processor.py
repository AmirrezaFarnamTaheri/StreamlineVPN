...
class ConfigurationProcessor:
    ...
    def process_config(self, config: str, source_url: Optional[str] = None) -> Optional[VPNConfiguration]:
    ...
    def _extract_host_port(self, config: str) -> Tuple[Optional[str], Optional[int]]:
