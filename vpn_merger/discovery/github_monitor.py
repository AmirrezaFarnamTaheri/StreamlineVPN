...
from .models import DiscoveredSource, GITHUB_TOPICS, detect_protocols_from_text
...
class GitHubRealtimeMonitor:
    ...
    async def monitor_topics(self, topics: Optional[List[str]] = None) -> List[DiscoveredSource]:
