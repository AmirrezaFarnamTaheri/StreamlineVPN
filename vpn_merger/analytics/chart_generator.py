...
from .models import ChartData, COLOR_SCHEMES, DEFAULT_CHART_HEIGHT, DEFAULT_CHART_WIDTH
...
class ChartGenerator:
    ...
    def create_line_chart(self, chart_id: str, title: str, x_data: List, y_data: List, 
                         x_label: str = "Time", y_label: str = "Value") -> Optional[ChartData]:
        """Create a line chart.
    ...
    def create_bar_chart(self, chart_id: str, title: str, categories: List[str], 
                        values: List[float], color_scheme: str = 'primary') -> Optional[ChartData]:
        """Create a bar chart.
    ...
    def create_pie_chart(self, chart_id: str, title: str, labels: List[str], 
                        values: List[float]) -> Optional[ChartData]:
        """Create a pie chart.
    ...
    def create_gauge_chart(self, chart_id: str, title: str, value: float, 
                          min_val: float = 0, max_val: float = 100) -> Optional[ChartData]:
    ...
    def create_scatter_plot(self, chart_id: str, title: str, x_data: List, y_data: List,
                           x_label: str = "X", y_label: str = "Y") -> Optional[ChartData]:
    ...
    def create_dashboard_layout(self, charts: List[ChartData], rows: int = 2, cols: int = 2) -> Optional[Dict[str, Any]]:
