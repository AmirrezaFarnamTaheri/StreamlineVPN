...
class TestVPNCacheService:
    ...
    async def test_get_configuration(self):
        ...
        with patch.object(service.l1_cache, 'get') as mock_l1, \
             patch.object(service.l2_cache, 'get') as mock_l2, \
             patch.object(service.l3_cache, 'get') as mock_l3:
    ...
    async def test_set_configuration(self):
        ...
        # Mock the cache layers
        with patch.object(service.l1_cache, 'set') as mock_l1, \
             patch.object(service.l2_cache, 'set') as mock_l2, \
             patch.object(service.l3_cache, 'set') as mock_l3:
    ...
    async def test_invalidate_configuration(self):
        ...
        # Mock the cache layers
        with patch.object(service.l1_cache, 'delete') as mock_l1, \
             patch.object(service.l2_cache, 'delete') as mock_l2, \
             patch.object(service.l3_cache, 'delete') as mock_l3:
