...
"""
    ...
    async def test_state_management(self):
        ...
        state_machine = state_manager.get_or_create_state_machine("test_source")
        assert state_machine is not None
        assert state_machine.current_state == SourceState.UNKNOWN
        
        # Test state transition
        success = state_manager.transition_source("test_source", SourceEvent.ENABLE)
    ...
    def test_data_models(self):
        ...
        # Test Job model
        job = Job(
            type=JobType.PROCESS_CONFIGURATIONS,
