...
from .models import (
    UserTier, ConnectionStatus, User, VPNServer, VPNConnection,
    LoginRequest, LoginResponse, ServerRecommendationRequest, ServerRecommendationResponse,
    ConnectionRequest, ConnectionResponse, VPNStatusResponse, WebSocketMessage
)
...
def create_app(secret_key: str = DEFAULT_JWT_SECRET_KEY, redis_nodes: list = None) -> APIServer:
