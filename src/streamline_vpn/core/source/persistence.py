...
class SourcePersistence:
                ...
                if isinstance(sources, dict):
                            ...
                            if isinstance(urls, list):
                                ...
                                try:
                                    ...
                                    _logging.getLogger().info(
                                        "Invalid tier configuration for %s", tier
                                    )
                                except Exception:
                                    pass
                        else:
                    ...
                    if tier_distribution:
                        ...
                        try:
                            ...
                            _logging.getLogger().info(
                                "Tier distribution: %s", tier_distribution
                            )
                        except Exception:
                            pass
    ...
    def add_source_atomically(
        self, sources: List[Dict[str, Any]], new_source: Dict[str, Any]
    ) -> bool:
