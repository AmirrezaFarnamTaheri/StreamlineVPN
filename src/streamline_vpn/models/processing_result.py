...
class ProcessingResult:
    ...
    def __repr__(self) -> str:
        ...
        return (
            f"ProcessingResult(url={self.url}, success={self.success}, "
...
class ProcessingStatistics:
    ...
    def __str__(self) -> str:
        """String representation."""
        return (
            f"ProcessingStats(sources={self.total_sources}, "
    ...
    def __repr__(self) -> str:
        """Detailed representation."""
        return (
            f"ProcessingStatistics(total_sources={self.total_sources}, "
