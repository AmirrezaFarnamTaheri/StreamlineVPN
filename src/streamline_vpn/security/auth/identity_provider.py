...
class IdentityProvider:
    ...
    async def verify_credentials(self, username: str, password: str, device_info: DeviceInfo) -> Optional[UserIdentity]:
    ...
    async def _authenticate_user(self, username: str, password: str) -> Optional[UserIdentity]:
