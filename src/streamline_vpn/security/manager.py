...
class SecurityManager:
    ...
    def analyze_configuration(self, config: str) -> Dict[str, Any]:
        ...
        try:
            ...
            # Pattern matching
            suspicious_patterns = self.pattern_analyzer.check_suspicious_patterns(config)
            
            # URL validation
            url_analysis = self.pattern_analyzer.analyze_urls(config, self.blocklist_manager.blocked_domains, self.validator)
    ...
    def validate_source(self, source_url: str) -> Dict[str, Any]:
        ...
        try:
            ...
            # Domain analysis
            domain_analysis = self.pattern_analyzer.analyze_domain(source_url, self.blocklist_manager.blocked_domains)
