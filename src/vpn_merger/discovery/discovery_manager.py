...
from .models import DEFAULT_DISCOVERY_INTERVAL, DiscoveredSource, DiscoveryMetrics
...
class RealTimeDiscovery:
    ...
    def _update_discovery_metrics(
        self, new_sources: list[DiscoveredSource], discovery_time: datetime
    ) -> None:
    ...
    def get_discovered_sources(
        self, source_type: str | None = None, min_reliability: float = 0.0, limit: int | None = None
